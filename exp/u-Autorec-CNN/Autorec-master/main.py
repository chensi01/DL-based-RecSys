...
from AutoRec_new import U_AutoRec
from AutoRec_maxpolling import AutoRec_maxpolling
...
result_path = './results/' + data_name + '/' + str(args.random_seed) + '_' + str(args.optimizer_method) + '_' + str(
	args.base_lr) + '_' + "U-AutoRec-mp" + '_' + str(args.window_size) + '_' + str(args.step_size) + "_" + str(
	current_time) + "/"
